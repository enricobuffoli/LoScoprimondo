...
<script src="js/psicologo/resize_P.js"></script>    
...
<link href="css/style_desktop.css" rel="stylesheet" type="text/css" " >
...
<div id="per_stampa">
<button class="bottoni" id="torna_gioco" style="display:none"><?php echo $TORNA; ?></button>
<button class="bottoni" id="stampa" style="display:none"><?php echo $BOTTONE08; ?></button>
</div>
...
src="images/elementi_sfondo/luna.png" >
<p><?php echo $ELEMENTO05_CAT01; ?></p>
</td>
<td>
<img border="0" class="draggable" id="mare" 
src="images/elementi_sfondo/mare.png" >
<p><?php echo $ELEMENTO06_CAT01; ?></p>
</td>
</tr>
...
src="images/elementi_sfondo/montagne.png" >
<p><?php echo $ELEMENTO07_CAT01; ?></p>
</td>
<td>
<img border="0" class="draggable" id="sole" 
 src="images/elementi_sfondo/sole.png" >
<p id='sole_p'><?php echo $ELEMENTO08_CAT01; ?></p>
</td>
</tr>
...
<div id="elementi_mancanti" style="display:none"></div>
