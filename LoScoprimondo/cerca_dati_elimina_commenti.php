...
echo '///'.'Madre Natura'.'///'.$riga['data'].'///'.$riga['commento'].'///'.$riga['id'];
...
echo '///'.'Madre Terra'.'///'.$riga2['data'].'///'.$riga2['commento'].'///'.$riga2['id'];
...
echo '///'.'Terra Padri'.'///'.$riga3['data'].'///'.$riga3['commento'].'///'.$riga3['id'];
...
echo '///'.'Madre Patria'.'///'.$riga4['data'].'///'.$riga4['commento'].'///'.$riga4['id'];
...
echo '///'.'Terra Frontiera'.'///'.$riga5['data'].'///'.$riga5['commento'].'///'.$riga5['id'];
